...
namespace HFInventApp.Areas.Identity.Pages.Account
{
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    {
                        await _userManager.AddToRoleAsync(user, RoleSD.Role_Guest);
                    }
                    ...
                    {
                        if(User.IsInRole(RoleSD.Role_Admin1) || User.IsInRole(RoleSD.Role_Admin2))
                        {
